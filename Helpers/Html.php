...
class Html
{
     ...
     * @param array|string $url the URL of the external CSS file.
     ...
     * @see endForm()
     */
    public static function beginForm($action = '', $method = 'post', $formKey = null, $options = [])
    {
        $hiddenInputs = [];
        if ($formKey !== null) {
            $hiddenInputs[] = static::hiddenInput('form_key', $formKey);
        }
